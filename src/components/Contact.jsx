...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "ed01babe-0117-42c5-8ee7-f20ffd957195");
    ...
    return (
        <motion.div
            ...
            <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
                ...
                <button className='bg-blue-600 text-white py-2 px-12 mb-10 rounded hover:bg-blue-700'>{result ? result : "Send Message"}</button>
            </form>
        </motion.div>
    )
}
